...
While Not KeyHit(1)
	...
	Text 320,0,"Pong27 2 player           " + P1score + " : " + P2score + "          by Shane Kennedy (www.fractalytic.co.uk)", True
	...
	If Bx# < -5 Or Bx# > 645 Or start = 0 Then 
		If Bx# < -5 Then P2score = P2score + 1
		If Bx# > 645 Then P1score = P1score + 1
		Bx# = 320
		By# = 240
		start = MilliSecs()
		Bangle = (Rand(1,60) + 120 * Rand(0,1)) * (-1 + 2*Rand(0,1))
	End If
